...
#Gestiona las etiquetas duplicadas añadiendo un número al final en caso de coincidencia
def update_key(dicct,kkey):
    occurrences = 0
#    for i in dicct.keys():
#        if kkey  
    
#            if (str(dicct.keys())).find(kkey):
#                print ("REPE: "+kkey+str(occurrences))
#                print("occurrences = "+str(occurrences))
#                ++occurrence

    return kkey+str(occurrences)
